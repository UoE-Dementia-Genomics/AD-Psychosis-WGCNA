...
#SBATCH --array=0-9 ## Numer of array should be equal to number of lines in coloc.input.csv file (each line will be run by an array)


ScriptDir=./Analysis/Colocalization

gwas_dir=./summary_stats
loci_dir=./regions
qtl_dir=./QTLs

out_prefix=./darkgreen
...
input_list=./coloc.input.csv # csv file with 4 columns (1st: GWAS Summary statistics file name, 2nd: loci file name, 3rd: QTL file name, 4th: Output file ID)
